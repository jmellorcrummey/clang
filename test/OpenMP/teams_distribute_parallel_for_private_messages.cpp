...
public:
  ...
  S5 &operator=(S5 &s) {
#pragma omp target
#pragma omp teams distribute parallel for private(a) private(this->a) private(s.a) // expected-error {{expected variable name or data member of current class}}
    for (int k = 0; k < s.a; ++k)
      ++s.a;
    return *this;
  }
...
#pragma omp teams distribute parallel for private(a) private(this->a) private(T::a)
  ...
  S7 &operator=(S7 &s) {
#pragma omp target
#pragma omp teams distribute parallel for private(a) private(this->a) private(s.a) private(s.T::a) // expected-error 2 {{expected variable name or data member of current class}}
...
#pragma omp teams distribute parallel for private(S1) // expected-error {{'S1' does not refer to a value}}
  for (int k = 0; k < argc; ++k)
    ++k;
#pragma omp target
#pragma omp teams distribute parallel for private(a, b) // expected-error {{private variable with incomplete type 'S1'}}
  for (int k = 0; k < argc; ++k)
    ++k;
#pragma omp target
#pragma omp teams distribute parallel for private(argv[1]) // expected-error {{expected variable name}}
  for (int k = 0; k < argc; ++k)
    ++k;
#pragma omp target
#pragma omp teams distribute parallel for private(e, g)
  for (int k = 0; k < argc; ++k)
    ++k;
#pragma omp target
#pragma omp teams distribute parallel for private(h) // expected-error {{threadprivate or thread local variable cannot be private}}
  for (int k = 0; k < argc; ++k)
    ++k;
#pragma omp target
#pragma omp teams distribute parallel for nowait // expected-error {{unexpected OpenMP clause 'nowait' in directive '#pragma omp teams distribute parallel for'}}
  for (int k = 0; k < argc; ++k)
    ++k;
#pragma omp parallel
  {
...
#pragma omp teams distribute parallel for private(e, g) // expected-error {{calling a private constructor of class 'S4'}} expected-error {{calling a private constructor of class 'S5'}}
  for (int k = 0; k < argc; ++k)
    ++k;
#pragma omp target
#pragma omp teams distribute parallel for private(h, B::x) // expected-error 2 {{threadprivate or thread local variable cannot be private}}
  for (int k = 0; k < argc; ++k)
    ++k;
#pragma omp target
#pragma omp teams distribute parallel for nowait // expected-error {{unexpected OpenMP clause 'nowait' in directive '#pragma omp teams distribute parallel for'}}
...
#pragma omp teams distribute parallel for private(i)
  ...
  static int m;
#pragma omp target
#pragma omp teams distribute parallel for private(m)
  for (int k = 0; k < argc; ++k)
    m = k + 2;
