...
int main(int argc, char **argv) {
  ...
  for (int i = 0; i < argc; ++i) foo();
  #pragma omp target teams distribute simd reduction(+ : ba)
  for (int i = 0; i < argc; ++i) foo();
  #pragma omp target teams distribute simd reduction(* : ca)
  for (int i = 0; i < argc; ++i) foo();
  #pragma omp target teams distribute simd reduction(- : da)
  for (int i = 0; i < argc; ++i) foo();
#endif
