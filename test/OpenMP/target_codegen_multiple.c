...
// CHK-CODEGEN-HOST: { i8*, i8*, { i8*, i8*, i64 }*, { i8*, i8*, i64 }* }* getelementptr inbounds ([2 x { i8*, i8*, { i8*, i8*, i64 }*, { i8*, i8*, i64 }* }], [2 x { i8*, i8*, { i8*, i8*, i64 }*, { i8*, i8*, i64 }* }]* @__omptgt__device_images, i32 0, i32 0),
...
int foo(int a){
  ...
  // CHK-CODEGEN-HOST:  %[[EBP1:[a-zA-Z0-9_\.]+]] = getelementptr inbounds i8*, i8** %[[BP1]], i32 0
  // CHK-CODEGEN-HOST:  %[[EP1:[a-zA-Z0-9_\.]+]] = getelementptr inbounds i8*, i8** %[[P1]], i32 0
  // CHK-CODEGEN-HOST:  %[[ES1:[a-zA-Z0-9_\.]+]] = getelementptr inbounds i64, i64* %[[S1]], i32 0
...
#pragma omp target
  ...
  for(i=0; i<5; ++i){
    ...
    // CHK-CODEGEN-HOST:  %[[EBP2:[a-zA-Z0-9_\.]+]] = getelementptr inbounds i8*, i8** %[[BP2]], i32 0
    // CHK-CODEGEN-HOST:  %[[EP2:[a-zA-Z0-9_\.]+]] = getelementptr inbounds i8*, i8** %[[P2]], i32 0
    // CHK-CODEGEN-HOST:  %[[ES2:[a-zA-Z0-9_\.]+]] = getelementptr inbounds i64, i64* %[[S2]], i32 0
