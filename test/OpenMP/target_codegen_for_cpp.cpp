...
// CK1-DAG: @C = global
// CK1-TGT-DAG: @C = global
// CK1: @__omptgt__[[G0:[0-9]+]]_[[ID:[0-9a-f]+_[0-9a-f]+]]__entry_name = internal constant [2 x i8] c"C\00"
// CK1: @__omptgt__[[G0]]_[[ID]]__entry

// CK1-DAG: @D = global
// CK1-TGT-DAG: @D = global
// CK1-DAG: @__omptgt__[[G1:[0-9]+]]_[[ID]]__entry_name = internal constant [2 x i8] c"D\00"
// CK1-DAG: @__omptgt__[[G1]]_[[ID]]__entry

// CK1-DAG: @YC = global
// CK1-TGT-DAG: @YC = global
// CK1-DAG: @__omptgt__[[G2:[0-9]+]]_[[ID]]__entry_name = internal constant [3 x i8] c"YC\00"
// CK1-DAG: @__omptgt__[[G2]]_[[ID]]__entry

// CK1-DAG: @YD = global
// CK1-TGT-DAG: @YD = global
// CK1-DAG: @__omptgt__[[G3:[0-9]+]]_[[ID]]__entry_name = internal constant [3 x i8] c"YD\00"
// CK1-DAG: @__omptgt__[[G3]]_[[ID]]__entry =

// CK1-DAG: @__omptgt__[[E0:[0-9]+]]_[[ID]]__entry_name = internal constant [{{[0-9]+}} x i8] c"__omptgt__[[E0]]_[[ID]]_\00"
// CK1-DAG: @__omptgt__[[E1:[0-9]+]]_[[ID]]__entry_name = internal constant [{{[0-9]+}} x i8] c"__omptgt__[[E1]]_[[ID]]_\00"

// CK1-DAG: @__omptgt__[[E0]]_[[ID]]__entry = constant { i8*, i8*, i64 } { i8* bitcast (void (i8*)* @__omptgt__dtor_caller{{.*}} to i8*)
// CK1-DAG: @__omptgt__[[E1]]_[[ID]]__entry = constant { i8*, i8*, i64 } { i8* bitcast (void (i8*)* @__omptgt__dtor_caller{{.*}} to i8*)

// Check entry that calls the global initializers
// CK1-DAG: @__omptgt__{{[0-9]+}}_[[ID]]__entry = constant { i8*, i8*, i64 } { i8* bitcast (void ()* @_GLOBAL__sub_I_target_codegen_for_cpp{{.*}} to i8*)

// Check that global ctors have the the target registraton and global initializers
// CK1-DAG: @llvm.global_ctors = appending global [2 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* }
// CK1-DAG: { i32 0, void ()* @_GLOBAL__A_000000_OPENMP_TGT, i8* null }
// CK1-DAG: { i32 65535, void ()* @_GLOBAL__sub_I_target_codegen_for_cpp{{.*}}, i8* null }
...
// CK1-TGT: define void @__omptgt__[[E0:[0-9]+]]_[[ID:[0-9a-f]+_[0-9a-f]+]]_() {
// CK1-TGT: call void @__cxx_global_var_init()
// CK1-TGT: call void @__ptxnamefix____cxx_global_var_init_1()
// CK1-TGT: call void @__ptxnamefix____cxx_global_var_init_2()
// CK1-TGT: call void @__ptxnamefix____cxx_global_var_init_3()

#endif

//CK1-LABEL: !openmp.offloading.info
//CK1-DAG: !{{[0-9]+}} = !{i32 0, !"C", i32 {{[0-9]+}}}
//CK1-DAG: !{{[0-9]+}} = !{i32 0, !"D", i32 {{[0-9]+}}}
//CK1-DAG: !{{[0-9]+}} = !{i32 0, !"YC", i32 {{[0-9]+}}}
//CK1-DAG: !{{[0-9]+}} = !{i32 0, !"YD", i32 {{[0-9]+}}}
//CK1-DAG: !{{[0-9]+}} = !{i32 1, !"_Z4testv", i32 {{[0-9]+}}}
//CK1-DAG: !{{[0-9]+}} = !{i32 2, i32 {{[0-9]+}}}
//CK1-DAG: !{{[0-9]+}} = !{i32 3, !"YC", i32 {{[0-9]+}}}
//CK1-DAG: !{{[0-9]+}} = !{i32 3, !"YD", i32 {{[0-9]+}}}
//CK1-DAG: !{{[0-9]+}} = !{i32 5, !"_ZN7MyClass3addERA64_i"}
//CK1-DAG: !{{[0-9]+}} = !{i32 5, !"_ZN7MyClass3addERS_"}
//CK1-DAG: !{{[0-9]+}} = !{i32 5, !"_ZN7MyClassC1Ev"}
//CK1-DAG: !{{[0-9]+}} = !{i32 5, !"_ZN7MyClassC2Ev"}
//CK1-DAG: !{{[0-9]+}} = !{i32 5, !"_ZN9YourClassC1ER7MyClass"}
//CK1-DAG: !{{[0-9]+}} = !{i32 5, !"_ZN9YourClassC2ER7MyClass"}
//CK1-DAG: !{{[0-9]+}} = !{i32 5, !"_ZN9YourClassD1Ev"}
//CK1-DAG: !{{[0-9]+}} = !{i32 5, !"_ZN9YourClassD2Ev"}
...
//CK2-LABEL: !openmp.offloading.info
//CK2-DAG: !{{[0-9]+}} = !{i32 1, !"_ZL3bari", i32 {{[0-9]+}}}
//CK2-DAG: !{{[0-9]+}} = !{i32 1, !"_Z3fooIdET_S0_", i32 {{[0-9]+}}}
//CK2-DAG: !{{[0-9]+}} = !{i32 1, !"_Z3fooIiET_S0_", i32 {{[0-9]+}}}
