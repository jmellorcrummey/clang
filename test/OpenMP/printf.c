...
// RUN: %clang_cc1 -verify -fopenmp -x c -triple nvptx64-nvidia-cuda -fomptargets=nvptx64-nvidia-cuda -emit-llvm %s -fopenmp-is-device -fomp-host-ir-file-path %t-ppc-host.bc -o - | FileCheck %s
