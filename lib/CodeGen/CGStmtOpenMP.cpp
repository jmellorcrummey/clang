...
static llvm::SmallVector<llvm::Value *, 16> emitLoopBounds(
                           CodeGenFunction &CGF,
...
void CodeGenFunction::EmitOMPDistributeParallelForSimdDirective(
  ...
  auto &&CGParForSimd = [&S](CodeGenFunction &CGF, PrePostActionTy &) {
    auto &&CodeGen = [&S](CodeGenFunction &CGF, PrePostActionTy &) {
  ...
  auto &&CodeGen = [&S, &CGParForSimd](CodeGenFunction &CGF,
                                 PrePostActionTy &) {
    CGF.EmitOMPDistributeLoop(S, CGParForSimd);
  };
  OMPLexicalScope Scope(*this, S, /*AsInlined=*/true);
...
void CodeGenFunction::EmitOMPDistributeSimdDirective(
  ...
  auto &&CGSimd = [&S, OutlinedSimd](CodeGenFunction &CGF, PrePostActionTy &) {
