...
void CGOpenMPRuntimeNVPTX::emitSMTEntryHeader(CodeGenFunction &CGF,
...
void CGOpenMPRuntimeNVPTX::emitSMTEntryFooter(CodeGenFunction &CGF,
                                              EntryFunctionState &EST) {
...
enum ExecutionMode {
  ...
  SPMD,
  /// \brief Simultaneous MultiThreading.
  SMT,
  Unknown,
};
...
void CGOpenMPRuntimeNVPTX::emitSMTKernel(const OMPExecutableDirective &D,
  ...
  public:
    ...
    void Enter(CodeGenFunction &CGF) override {
      RT.emitSMTEntryHeader(CGF, EST, WST);
    }
    void Exit(CodeGenFunction &CGF) override {
      RT.emitSMTEntryFooter(CGF, EST);
    }
  } Action(*this, EST, WST);
...
void CGOpenMPRuntimeNVPTX::emitTargetOutlinedFunction(
  ...
  switch (mode) {
  case ExecutionMode::SMT:
    emitSMTKernel(D, ParentName, OutlinedFn, OutlinedFnID, IsOffloadEntry,
                  CodeGen);
    break;
...
bool CGOpenMPRuntimeNVPTX::generateCoalescedSchedule(
    ...
    bool Ordered) const {
  return DistScheduleKind == OMPC_DIST_SCHEDULE_unknown &&
